...
export class ManifestBuilder {
   ...
   */
  addStatistics(manifest: Manifest, statistics: Record<string, any>): Manifest & { statistics: Record<string, any> } {
   ...
   */
  validate(manifest: Manifest): { isValid: boolean; errors: string[] } {
    const errors: string[] = [];
